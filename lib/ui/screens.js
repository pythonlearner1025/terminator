...
export class Screens {
  ...
  formatSetting(key,value){return key==='crosshair'?(value?'ON':'OFF'):key==='sensitivity'?`${Number(value).toFixed(2)}x`:key==='fov'?`${value}°`:`${value}%`}
