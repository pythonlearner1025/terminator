...
.tm-setting input[type=checkbox]{width:28px;height:28px;justify-self:start;accent-color:#a9dbf8;cursor:pointer;margin:0}
.tm-setting-toggle{cursor:pointer}.tm-setting-toggle:hover span,.tm-setting-toggle:focus-within span{color:#e7f7ff}
...
.tm-skynet-row.tm-revs{display:flex;align-items:center;justify-content:space-between;gap:10px}
.tm-skynet-row.tm-reservoir{display:flex;align-items:center;gap:10px;margin-top:7px;font:16px/1 ui-monospace,monospace;letter-spacing:.09em;color:#ffb3b9;white-space:nowrap}
.tm-director-state{font:11px/1 ui-monospace,monospace;letter-spacing:.18em;color:#12202a;background:var(--red);padding:3px 6px}
.tm-caches{position:absolute;inset:0;pointer-events:none}
.tm-cache-marker{position:absolute;transform:translate(-50%,-50%);text-align:center;color:#63f0a2;filter:drop-shadow(0 0 7px #2fd98366)}
.tm-cache-marker .tm-icon{width:22px;height:22px;display:block;margin:0 auto}.tm-cache-marker small{font:12px ui-monospace,monospace;letter-spacing:.06em}
.tm-extraction{position:absolute;text-align:center;transform:translate(-50%,-50%);color:#8fdcff;background:#0c141bd9;border:1px solid #8fdcff80;padding:9px 13px;min-width:110px;pointer-events:none}
.tm-extraction .tm-icon{width:22px;height:22px;display:block;margin:0 auto}.tm-extraction small{font:15px ui-monospace,monospace}
