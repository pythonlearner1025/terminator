...
const SYNTH_CATALOG = Object.freeze({
  ...
  horde_stinger: sound('effects', 0.8, 3, pair(
    {duration: 2, drive: 2.2, tones: [
      {freq: 55, endFreq: 196, gain: 0.5, attack: 0.09, decay: 3, sustain: 0.82, end: 2, wave: 'saw'},
      {freq: 110, endFreq: 392, gain: 0.24, attack: 0.14, decay: 3, sustain: 0.72, end: 1.94, wave: 'triangle', tremolo: 5, tremoloDepth: 0.42},
      {freq: 233, gain: 0.3, attack: 0.035, decay: 1.4, sustain: 0.62, start: 0.92, end: 1.42, wave: 'square'},
      {freq: 196, gain: 0.3, attack: 0.035, decay: 1.4, sustain: 0.62, start: 1.48, end: 1.98, wave: 'square'},
    ], noise: [{color: 'high', gain: 0.15, decay: 2.6, sustain: 0.8, end: 2, flutter: 7, flutterDepth: 0.55}]},
    {duration: 2.05, drive: 2.2, tones: [
      {freq: 49, endFreq: 175, gain: 0.52, attack: 0.09, decay: 3, sustain: 0.82, end: 2.05, wave: 'saw'},
      {freq: 98, endFreq: 349, gain: 0.23, attack: 0.14, decay: 3, sustain: 0.72, end: 1.98, wave: 'triangle', tremolo: 4.4, tremoloDepth: 0.44},
      {freq: 220, gain: 0.29, attack: 0.035, decay: 1.4, sustain: 0.62, start: 0.96, end: 1.46, wave: 'square'},
      {freq: 185, gain: 0.29, attack: 0.035, decay: 1.4, sustain: 0.62, start: 1.52, end: 2.03, wave: 'square'},
    ], noise: [{color: 'high', gain: 0.14, decay: 2.6, sustain: 0.8, end: 2.05, flutter: 6.2, flutterDepth: 0.52}]},
  )),
  aerial_whine: sound('effects', 0.5, 6, pair(
    {duration: 1.35, drive: 1.6, tones: [
      {freq: 640, endFreq: 2150, gain: 0.34, attack: 0.1, decay: 1.6, sustain: 0.6, end: 1.35, wave: 'triangle'},
      {freq: 213, endFreq: 716, gain: 0.2, attack: 0.12, decay: 1.5, sustain: 0.55, end: 1.35, wave: 'saw', tremolo: 24, tremoloDepth: 0.35},
    ], noise: [{color: 'high', gain: 0.2, decay: 1.4, sustain: 0.6, end: 1.35, flutter: 41, flutterDepth: 0.6}]},
    {duration: 1.25, drive: 1.6, tones: [
      {freq: 710, endFreq: 2380, gain: 0.32, attack: 0.09, decay: 1.5, sustain: 0.6, end: 1.25, wave: 'triangle'},
      {freq: 236, endFreq: 793, gain: 0.19, attack: 0.11, decay: 1.4, sustain: 0.55, end: 1.25, wave: 'saw', tremolo: 27, tremoloDepth: 0.33},
    ], noise: [{color: 'high', gain: 0.19, decay: 1.3, sustain: 0.6, end: 1.25, flutter: 37, flutterDepth: 0.58}]},
  )),
  t1000_shimmer: sound('effects', 0.46, 6, pair(
    {duration: 1.1, drive: 1.3, tones: [
      {freq: 1860, endFreq: 2790, gain: 0.2, attack: 0.02, decay: 0.9, end: 1.1, tremolo: 17, tremoloDepth: 0.7},
      {freq: 2480, endFreq: 1240, gain: 0.14, attack: 0.05, decay: 0.75, end: 1.1, tremolo: 23, tremoloDepth: 0.75},
      {freq: 124, endFreq: 62, gain: 0.22, decay: 0.5, end: 1.1, wave: 'triangle'},
    ], noise: [{color: 'high', gain: 0.12, decay: 0.85, sustain: 0.35, end: 1.1, flutter: 13, flutterDepth: 0.8}]},
    {duration: 1.18, drive: 1.3, tones: [
      {freq: 1660, endFreq: 3110, gain: 0.19, attack: 0.02, decay: 0.95, end: 1.18, tremolo: 15, tremoloDepth: 0.72},
      {freq: 2210, endFreq: 1105, gain: 0.13, attack: 0.05, decay: 0.8, end: 1.18, tremolo: 21, tremoloDepth: 0.73},
      {freq: 110, endFreq: 55, gain: 0.23, decay: 0.55, end: 1.18, wave: 'triangle'},
    ], noise: [{color: 'high', gain: 0.11, decay: 0.9, sustain: 0.35, end: 1.18, flutter: 11, flutterDepth: 0.78}]},
  )),
  cache_pickup: sound('effects', 0.5, 4, pair(
    {duration: 0.52, tones: [{freq: 523.3, gain: 0.26, decay: 0.16, end: 0.3}, {freq: 784, gain: 0.24, decay: 0.24, start: 0.11, end: 0.52}], pulses: [{times: [0], freq: 1570, gain: 0.34, duration: 0.07, decay: 0.02, noiseMix: 0.3, color: 'high'}]},
    {duration: 0.56, tones: [{freq: 587.3, gain: 0.25, decay: 0.17, end: 0.32}, {freq: 880, gain: 0.23, decay: 0.26, start: 0.12, end: 0.56}], pulses: [{times: [0], freq: 1760, gain: 0.33, duration: 0.07, decay: 0.02, noiseMix: 0.3, color: 'high'}]},
  )),
  extraction_beacon: sound('effects', 0.44, 3, pair(
    {duration: 2, fadeEdges: 0.02, hum: 37, humGain: 0.05, tones: [{freq: 880, gain: 0.3, attack: 0.02, decay: 0.3, end: 0.42}, {freq: 660, gain: 0.26, attack: 0.02, decay: 0.3, start: 1, end: 1.42}], noise: [{color: 'low', gain: 0.05, decay: 2.2, sustain: 0.6, end: 2, flutter: 0.5, flutterDepth: 0.6}]},
    {duration: 2, fadeEdges: 0.02, hum: 33, humGain: 0.05, tones: [{freq: 932.3, gain: 0.29, attack: 0.02, decay: 0.3, end: 0.44}, {freq: 698.5, gain: 0.25, attack: 0.02, decay: 0.3, start: 1, end: 1.44}], noise: [{color: 'low', gain: 0.05, decay: 2.2, sustain: 0.6, end: 2, flutter: 0.42, flutterDepth: 0.58}]},
  ), {loop: true}),
