...
export class Pacer {
  ...
  sync() {
    ...
    // The trader opens only between waves, when every enemy is dead.
    // A relax window sits inside a live wave, so it keeps the trader shut.
    this.world.traderOpen = this.world.phase === 'intermission'
  }
