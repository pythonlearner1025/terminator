...
import defaultHkAerialScriptSource from '../brains/default-hkaerial.script-src.js'
import defaultHkTankScriptSource from '../brains/default-hktank.script-src.js'
import defaultScoutScriptSource from '../brains/default-scout.script-src.js'
import defaultT1000ScriptSource from '../brains/default-t1000.script-src.js'
...
export const DEFAULT_SCRIPT_SOURCES = Object.freeze({
  ...
  t1000: defaultT1000ScriptSource,
  hkaerial: defaultHkAerialScriptSource,
  hktank: defaultHkTankScriptSource,
})
