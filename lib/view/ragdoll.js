...
export class RagdollSystem {
  ...
  makeBody(mass=1){
    ...
    body.addShape(new Box(new Vec3()));body.sleep();return body
  }
  primePools(){
    while(this.freeBodies.length<100)this.freeBodies.push(this.makeBody())
  ...
  addDetached(mesh, velocity, release) {
    if(this.activeCount('limb')>=12)this.freeze(this.firstActive('limb'))
