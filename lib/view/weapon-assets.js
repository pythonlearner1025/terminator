...
const strip = object => object.traverse(n=>{
  for(const k of ['rootPath','sProperties','rootPathOptions','EntityComponentPlugin','kite3dGenerated','kite3dAuthoring','kite3dRuntime','excludeFromExport'])delete n.userData[k]
})
