...
export class CameraFeel {
  constructor(){this.eventIndex=0;this.kick=0;this.velocity=0;this.roll=0;this.rollVelocity=0;this.dip=0;this.dipVelocity=0;this.shake=0;this.lastTime=0;this.headshotKills=0;this.shots=0}
  consume(world) {
    ...
    for(;this.eventIndex<world.eventLog.length;this.eventIndex++){
      ...
      if(event.type==='kill' && event.headshot && (event.playerId||player.id)===player.id){this.headshotKills++}
    }
  }
  ...
  dispose(){this.kick=0;this.velocity=0;this.roll=0;this.rollVelocity=0;this.dip=0;this.dipVelocity=0;this.shake=0;this.lastTime=0}
}
