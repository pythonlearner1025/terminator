...
export class LabEnvironment {
  ...
  start() {
    ...
    this.owner = new RuntimeObjectOwner('weapons-lab-environment')
    this.root = this.owner.attachRuntimeRoot(new E.Group(), scene, scene.modelRoot.getObjectByName('Range'))
