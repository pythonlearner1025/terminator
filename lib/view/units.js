...
export class UnitView {
  ...
  stop() {
    ...
    // RuntimeObjectOwner disposes resources by walking its owned roots. Return
    // every parked allocation before that walk, including untracked warmup rigs.
    ...
    this.owner?.cleanup();this.owner=null;this.root=null;this.dormantRoot=null;this.templates={};this.runtimeTemplates={};this.runtimeFarTemplates={};this.materials=null;this.visuals.clear();this.activeIds.clear();this.eventIndex=0;this.visualPool={}
  }
}
