...
export class UnitView {
  ...
  cloneTemplateFigure(unit, parent=this.root) {
    ...
    object.traverse(child=>{
      ...
      if(child.name==='Eye Bloom'||child.name==='Muzzle Heat') {
  ...
  stop() {
    ...
    this.owner?.cleanup();this.owner=null;this.root=null;this.templates={};this.runtimeTemplates={};this.materials=null;this.visuals.clear();this.eventIndex=0
  }
}
