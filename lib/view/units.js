  ...
  sync(world) {
    ...
    for(const unit of world.units) {
      ...
      if(unit.alive&&visual.rosterDeath){
        this.recycleVisual(unit.id,visual,unit.type);visual=this.cloneTemplateFigure(unit);this.visuals.set(unit.id,visual)
      }
      ...
      const geometry=distance>this.quality.lodDistance&&!visual.gore?.deformer.changed?visual.rig.lowGeometry:visual.rig.highGeometry
