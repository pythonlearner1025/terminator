...
export class MapPost {
  constructor(viewer) { this.viewer = viewer; this.plugins = []; this.settings = {motionBlur: WEATHER_DEFAULTS.motionBlur} }
  start() {
  ...
  stop() {
    ...
    this.plugins = []; this.combine = null; this.rotation = null
  }
}
