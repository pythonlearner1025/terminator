...
export const PROJECTILE_STYLE=Object.freeze({
  round:{renderer:'streak',width:.20,glow:.90,trail:6,pixels:48,opacity:.75,color:[5.2,1.15,.08]},
  bolt:{renderer:'orb',width:.30,glow:1.05,trail:6,pixels:48,opacity:.55,color:[3.5,.18,5.2]},
  shell:{renderer:'shell',width:.16,glow:.40,trail:3.2,pixels:48,opacity:.45,color:[3.6,.8,.08]},
...
export class ProjectileView {
  ...
  sync(world,camera) {
    ...
    for(let i=0;i<world.projectiles.length;i++) {
      ...
      this.streaks.add(this.from,this.to,style,style.opacity)
