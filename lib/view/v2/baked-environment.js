...
const semantic=data=>Object.fromEntries(Object.entries(data||{}).filter(([k])=>!['gltfUUID','kite3dAuthoring','kiteAuthoring','EntityComponentPlugin','gltfExtensions','__autoBubbleToParentEvents'].includes(k)))
