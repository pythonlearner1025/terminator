...
export class UnitFx {
  ...
  dispose() {
    ...
    this.root.removeFromParent();for(const resource of resources)resource.dispose()
...
export class WeaponFx {
  ...
  dispose() {
    ...
    this.root.removeFromParent();this.geometry.dispose();this.material.dispose();this.map.dispose()
  }
}
