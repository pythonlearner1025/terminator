...
for f in sorted(P.iterdir()):
 ...
 deriv='Derived from Poly Haven Rusty Metal 02, CC0 1.0, using tools/bake-map-textures.py.' if f.name.startswith(('paint_','corrugated_')) else 'Original procedural bake, tools/bake-map-textures.py. No third party source; project asset.'
